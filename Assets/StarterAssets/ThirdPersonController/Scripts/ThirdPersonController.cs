...
#endif
    public class ThirdPersonController : Entity, IHealth
    {
        [Header("Player")]
        ...
        private GameObject _mainCameraTransform;
        ...
        {
            aimObj.transform.position = CinemachineCameraTarget.transform.position +
        ...
        private void CheckHitAttack()
        {
            ...
            foreach (var col in cols)
            {
                ...
                if (haveHealthEntity.Equals(this)) continue;
                haveHealthEntity.TakeDamge(attackDamge, new HealthEventHandler(gameObject, healthTeamSide));
            }
        }
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                _targetRotation = Mathf.Atan2(inputDirection.x, inputDirection.z) * Mathf.Rad2Deg +
                                  _mainCameraTransform.transform.eulerAngles.y;
